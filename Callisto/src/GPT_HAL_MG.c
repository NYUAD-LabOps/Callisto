...
ssp_err_t open_timers(void)
{
    ...
    err = g_timer_gpt_3.p_api->open (g_timer_gpt_3.p_ctrl, g_timer_gpt_3.p_cfg);
    error_handle (err, "open failed");

    err = g_timer_gpt_4.p_api->open (g_timer_gpt_4.p_ctrl, g_timer_gpt_4.p_cfg);
    error_handle (err, "open failed");

    err = g_timer_gpt_7.p_api->open (g_timer_gpt_7.p_ctrl, g_timer_gpt_7.p_cfg); // Open timers
    error_handle (err, "open failed");
